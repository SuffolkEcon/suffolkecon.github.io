...
and that suffices for a basic notebook. For more options see [the Markdown checkpoint](link to markdown cheatsheet).


### Text

Just write plain text in [Markdown](link to markdown cheatsheet)
