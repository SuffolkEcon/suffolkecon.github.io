...
Python is great. You should learn it, too. Especially if you plan on a career in data science. (Check out https://quantecon.org/.) But it is easier to start with one language and then switch to another. (Heads up, [you can use Python in R Studio](https://blog.rstudio.com/2018/03/26/reticulate-r-interface-to-python/).) We prefer starting with R because unlike Python, a general programming language, R was built specifically to analyze data and build models.

## ...Stata?

Stata is an incredible tool for econometrics. The problem is that it is built for academics, and thus is not widely used in industry. Also, you have to pay for it. 
